...
vim.cmd("nnoremap <leader>ss :SSave<CR>")
vim.cmd("nnoremap <leader>sc :SClose<CR>")
vim.cmd("nnoremap <leader>sd :SDelete<CR>")
vim.cmd("nnoremap <leader>sl :SLoad<CR>")
vim.cmd("nnoremap <silent> <leader><space> :noh<cr>")
...
vim.cmd("map Q gq")
vim.cmd("map <leader>s :!clear && shellcheck -x %<CR>")
vim.cmd("nmap <leader>y :History:<CR>")
